...
export const HAS_ONE = (targetModel, options) => ASSOCIATION(HAS_ONE.type, targetModel, options);
HAS_ONE.type = 'hasOne';

export const HAS_MANY = (targetModel, options) => ASSOCIATION(HAS_MANY.type, targetModel, options);
HAS_MANY.type = 'hasMany';

export const BELONGS_TO = (targetModel, options) => ASSOCIATION(BELONGS_TO.type, targetModel, options);
