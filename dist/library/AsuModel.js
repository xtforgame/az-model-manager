...
var autoInclude = function autoInclude(asuOrm, modelName, values) {
  ...
  if (asuModel && values) {
    Object.keys(asuModel.associations).forEach(function (associationName) {
  ...
  _createClass(AzuModel, [{
    ...
    value: function getNormalizedSettings(modelName) {
      var _this$tableDefine = this.tableDefine,
          ...
          options = _this$tableDefine.options;
      var associations = {};
      var columns = {};
